namespace WNS.Time.Control
{
    ...
    public class RendererFadeArray : BaseRendererEffectArray
    {
        public RendererFadeArray( SpriteRenderer[] _rdr, float _start, float _end, float _duration )
                                  : base( _rdr, _start, _end, _duration )
                                  => Restart();

        public RendererFadeArray( List<SpriteRenderer> _rdr, float _start, float _end, float _duration )
                                  : base( _rdr, _start, _end, _duration )
                                  => Restart();
