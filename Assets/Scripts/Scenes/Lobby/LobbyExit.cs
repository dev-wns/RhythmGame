...
public class LobbyExit : SceneOptionBase
{
    public override void KeyBind()
    {
        ...
        CurrentScene.Bind( SceneAction.Exit, KeyCode.LeftArrow,  () => SoundManager.Inst.Play( SoundSfxType.Move ) );

        CurrentScene.Bind( SceneAction.Exit, KeyCode.RightArrow, () => NextMove() );
        CurrentScene.Bind( SceneAction.Exit, KeyCode.RightArrow, () => SoundManager.Inst.Play( SoundSfxType.Move ) );
        ...
        CurrentScene.Bind( SceneAction.Exit, KeyCode.Escape, () => SoundManager.Inst.Play( SoundSfxType.Escape ) );
    }
